...
| `20250126_create_invoice_requests_filtered_function.sql` | 1个 | 开票申请单管理 | ⭐⭐⭐ |
...
**文件3 - 开票申请单管理**（必须执行）⭐
```
📁 20250126_create_invoice_requests_filtered_function.sql
包含：get_invoice_requests_filtered（新建）
⚠️ 前端已更新使用此函数，必须执行！
```
