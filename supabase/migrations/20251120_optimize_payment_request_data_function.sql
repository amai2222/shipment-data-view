...
-- 注意：索引创建已拆分到 20251120_create_payment_indexes.sql
-- ============================================================================
...
COMMENT ON FUNCTION public.get_payment_request_data_1120 IS '获取付款申请数据，支持多个 project_id（逗号分隔的 UUID 字符串）- 性能优化版本';

-- ============================================================================
-- 函数创建完成
-- ============================================================================
-- 
-- ✅ get_payment_request_data_1120 函数创建成功
-- 
-- 优化内容：
...
--   3. 支持多项目ID筛选
-- 
-- 注意：请单独执行 20251120_create_payment_indexes.sql 创建索引
