-- 修复司机项目关联功能中的字段冲突问题
-- 文件: supabase/migrations/20250120000012_fix_project_id_ambiguous.sql

-- 重新创建查找司机对应项目的函数，明确指定表别名
    ...
    LOOP
        ...
        IF array_length(driver_info.project_ids, 1) > 0 THEN
            ...
            LOOP
                ...
                VALUES (driver_info.driver_id, v_project_id)
