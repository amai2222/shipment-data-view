...
-- 1) Create restricted table for partner bank details
...
-- 2) Migrate existing data from partners to partner_bank_details
INSERT INTO public.partner_bank_details (partner_id, bank_account, bank_name, branch_name, user_id)
SELECT id, bank_account, bank_name, branch_name, COALESCE(user_id, auth.uid())
...
-- 3) Update RPC to read bank fields from partner_bank_details
...
-- 4) Remove bank columns from partners to enforce separation
