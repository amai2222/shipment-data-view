-- ============================================================================
-- 为driver_quick_create_waybill函数添加日期参数
-- 创建时间：2025-11-10
-- 功能：支持指定装货日期和卸货日期，默认都是当天
-- ============================================================================
...
BEGIN
    ...
    INSERT INTO logistics_records (
        ...
        p_loading_date,                    -- 使用传入的装货日期
        p_unloading_date,                  -- 使用传入的卸货日期
        p_loading_weight,
...
COMMENT ON FUNCTION driver_quick_create_waybill IS '内部司机快速创建运单（支持指定装货和卸货日期，默认都是当天）';
