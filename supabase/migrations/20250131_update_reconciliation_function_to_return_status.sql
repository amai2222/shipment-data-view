-- ============================================================================
-- 功能：更新 get_finance_reconciliation_by_partner_1116 函数，返回对账状态
-- 日期：2025-11-16
-- 说明：在运费对账查询中返回每个合作方成本的对账状态
-- ============================================================================
...
COMMENT ON FUNCTION public.get_finance_reconciliation_by_partner_1116(
    p_project_id text,
    p_start_date date,
    p_end_date date,
    p_partner_id uuid,
...
) IS '运费对账查询函数（支持对账状态筛选和返回对账信息）';

-- 验证函数已更新
DO $$
BEGIN
    RAISE NOTICE '✅ get_finance_reconciliation_by_partner_1116 函数已更新：添加对账状态支持';
END $$;
