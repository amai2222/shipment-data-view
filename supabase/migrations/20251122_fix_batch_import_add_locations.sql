-- ============================================================================
-- 修复批量导入函数：添加地点自动创建和项目关联
-- ============================================================================
-- 问题：batch_import_logistics_records_with_update 函数没有将装货地点和卸货地点
--      插入到 locations 表，也没有关联地点到项目
-- 导致：导入的地点数据只存在于 logistics_records 表中，无法在地点管理中查看和管理
-- 解决：在插入/更新运单记录前，查找或创建地点，并关联地点到项目
-- ============================================================================
...
-- 验证
SELECT '✅ 函数已修复：添加了地点自动创建和项目关联功能' AS status;
