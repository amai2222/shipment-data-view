...
export interface IntegratedUserPermissionManagerProps {
  users: UserWithPermissions[];
  onUpdate: () => void;
}

export function IntegratedUserPermissionManager({ users, onUpdate }: IntegratedUserPermissionManagerProps) {
