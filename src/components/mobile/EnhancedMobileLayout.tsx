...
import { OfflineState } from './MobileEmptyState';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {showHeader && (
        ...
        >
          {isSlowConnection && (
            <div className="bg-orange-500/10 text-orange-600 text-xs text-center py-1 px-4">
              <span>网络连接较慢</span>
            </div>
          )}
          ...
          <div className="flex h-14 items-center px-4">
            <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              ...
              <SheetContent side="left" className="w-[280px] sm:w-[320px] p-0">
                <div className="flex flex-col h-full">
                  ...
                  {/* 用户信息 */}
                  <div className="flex items-center space-x-3 m-4 p-3 rounded-lg bg-muted/50">
            ...
            <div className="flex-1 text-center">
              <h1 className="text-lg font-semibold truncate">{title || '物流管理系统'}</h1>
            </div>
      ...
      {/* 主内容区域 */}
      <main 
        className={cn('container mx-auto px-4 py-4 max-w-full', className)}
        data-scrollable
        style={{
