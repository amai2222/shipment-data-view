...
export class SupabaseStorage {
  ...
  static async getLogisticsRecords(): Promise<LogisticsRecord[]> {
    ...
    return data?.map(record => ({
      ...
      loadingTime: record.loading_time,
      ...
      currentCost: record.current_cost,
      extraCost: record.extra_cost,
      payableCost: record.payable_cost,
  ...
  static async addLogisticsRecord(record: Omit<LogisticsRecord, 'id' | 'autoNumber' | 'createdAt'>): Promise<LogisticsRecord> {
    ...
    const { data, error } = await supabase
      ...
      .insert([{
        ...
        current_cost: record.currentCost,
        extra_cost: record.extraCost,
        payable_cost: record.payableCost,
        remarks: record.remarks,
  ...
  static async updateLogisticsRecord(id: string, updates: Partial<LogisticsRecord>): Promise<void> {
    const { error } = await supabase
      ...
      .update({
        ...
        loading_time: updates.loadingTime,
        ...
        current_cost: updates.currentCost,
        extra_cost: updates.extraCost,
        payable_cost: updates.payableCost,
