  ...
  const exportFilteredToExcel = async () => {
    ...
    try {
      ...
      while (hasMore) {
        ...
        const { data, error } = await supabase.rpc<RpcResponse>('get_logistics_summary_and_records_enhanced_1120', {
          ...
          p_invoice_status: activeFilters.invoiceStatus || null,
          p_payment_status: activeFilters.paymentStatus || null,
          p_receipt_status: activeFilters.receiptStatus || null,
