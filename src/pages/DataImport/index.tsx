...
export default function DataImportWithDuplicateCheck() {
  ...
  const handleTemplateDownload = () => {
    ...
    const colWidths = [
      { wch: 18 }, { wch: 15 }, { wch: 12 }, { wch: 15 }, { wch: 18 }, { wch: 18 }, { wch: 18 }, { wch: 15 }, { wch: 18 }, { wch: 15 }, { wch: 15 }, { wch: 15 }, { wch: 15 }, { wch: 18 }, { wch: 18 }, { wch: 25 }, { wch: 30 }
    ];
    ws['!cols'] = colWidths;
            ...
            <div className="grid gap-4">
             ...
             <div className="p-4 border-l-4 border-blue-400 bg-blue-50 text-blue-800 rounded-md">
               ...
               <ol className="list-decimal pl-5 mt-2 text-sm space-y-1">
                 ...
                 <li><strong>填写数据</strong>：按照模板格式填写运单信息</li>
                 <li><strong>选择文件</strong>：点击"选择文件"按钮上传Excel文件</li>
                 <li><strong>预览确认</strong>：系统会显示重复数据检测结果</li>
                 <li><strong>执行导入</strong>：确认后系统开始批量导入</li>
                 <li><strong>查看结果</strong>：导入完成后查看统计信息</li>
               </ol>
             </div>
          </CardContent>
        </Card>
