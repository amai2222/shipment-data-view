    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm text-muted-foreground">加载操作日志中...</p>
        </div>
      </div>
    );
  }
                ...
                {loading ? (
                  ...
                  auditLogs.map((log) => (
                    <TableRow key={log.id}>
                      ...
                      <TableCell>
                        {log.target_user_name ? (
                          <div className="text-sm">
                            ...
                            <div className="text-muted-foreground">{log.target_user_email}</div>
                          </div>
                        ) : (
                      ...
                      <TableCell>
                        <div className="text-sm font-mono">{log.permission_key}</div>
                      </TableCell>
                      <TableCell>
                        <div className="text-sm">
                          <div className="font-medium">{log.created_by_name}</div>
                          <div className="text-muted-foreground">{log.created_by_email}</div>
                        </div>
                      </TableCell>
                      <TableCell>
                        <Button
